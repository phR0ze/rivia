...
impl fmt::Display for VfsError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            VfsError::InvalidChmodOp(ref sym) => write!(f, "invalid chmod operation given: {}", sym),
            VfsError::InvalidChmodPermissions(ref sym) => write!(f, "invalid chmod permissions given: {}", sym),
            VfsError::InvalidChmodTarget(ref sym) => write!(f, "invalid chmod target given: {}", sym),
