...
mod tests
{
    ...
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().contents_first().into_iter();
    ...
    //     assert_stdfs_mkdir!(&zdir1);
    //     assert_stdfs_mkdir!(&zdir2);
    ...
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().files_first().sort(|x, y|
    // y.file_name().cmp(&x.file_name())).into_iter();     assert_eq!(iter.next().unwrap().
    // unwrap().path(), tmpdir);     assert_eq!(iter.next().unwrap().unwrap().path(), file2);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), zdir2);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir2file2);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir2file1);
    ...
    // #[test]
    // fn test_vfs_entries_max_descriptors()
    // {
    //     let tmpdir = assert_stdfs_setup!();
    //     let dir1 = tmpdir.mash("dir1");
    //     let file1 = dir1.mash("file1");
    ...
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir2);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file2);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir3);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file3);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file1);
    //     assert!(iter.next().is_none());
    ...
    // #[test]
    // fn test_vfs_entries_loop_detection()
    // {
    //     let tmpdir = assert_stdfs_setup!();
    //     let dir1 = tmpdir.mash("dir1");
    //     let dir2 = dir1.mash("dir2");
    ...
    //     // Files only
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().files().into_iter();
    //     assert_eq!(iter.next().unwrap().unwrap().path(), link1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file3);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file2);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file1);
    ...
    //     // Dirs only
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().dirs().into_iter();
    //     assert_eq!(iter.next().unwrap().unwrap().path(), tmpdir);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), link2);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir2);
    //     assert!(iter.next().is_none());
    ...
    //     // Custom name
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().into_iter().filter_p(|x|
    // x.path().has_suffix("1"));     assert_eq!(iter.next().unwrap().unwrap().path(), link1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file1);
    //     assert!(iter.next().is_none());
    ...
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().max_depth(1).into_iter();
    //     assert_eq!(iter.next().unwrap().unwrap().path(), tmpdir);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir1);
    //     assert!(iter.next().is_none());
    ...
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().max_depth(2).into_iter();
    //     assert_eq!(iter.next().unwrap().unwrap().path(), tmpdir);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir2);
    ...
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().min_depth(1).into_iter();
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir2);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir2file1);
    ...
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().min_depth(1).max_depth(1).into_iter();
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir1);
    //     assert!(iter.next().is_none());

    //     // Min: 1, Max: 2 = skip root, hit root's chilren and theirs only
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().min_depth(1).max_depth(2).into_iter();
    //     assert_eq!(iter.next().unwrap().unwrap().path(), file1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir1);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir2);
    //     assert_eq!(iter.next().unwrap().unwrap().path(), dir1file1);
    ...
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().min_depth(2).max_depth(1).into_iter();
    ...
    //     let mut iter = Stdfs::entries(&tmpdir).unwrap().max_depth(1).min_depth(2).into_iter();
