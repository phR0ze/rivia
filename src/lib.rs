...
pub mod prelude
{
    ...
    pub use crate::{
        ...
        assert_vfs_remove, assert_vfs_remove_all, assert_vfs_setup, assert_vfs_symlink, cfgblock, function,
        function_fqn, panic_compare_msg, panic_msg, trying, unwrap_or_false,
    };
